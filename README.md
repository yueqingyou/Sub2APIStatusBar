...
```bash
VERSION=v0.1.12 ./scripts/build-app.sh
```
...
```bash
VERSION=v0.1.12 ./scripts/package-release.sh
```

Output:

```text
dist/Sub2APIStatusBar-0.1.12-macOS.zip
dist/Sub2APIStatusBar-0.1.12-macOS.zip.sha256
```
