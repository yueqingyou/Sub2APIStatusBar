/*
 * Derived from the Waveshare ESP32-S3-RLCD-4.2 ST7305 adapter at commit
 * eb1f63427d735a22b9c30e22fa63ebddae1834d3.
 * Copyright 2026 Waveshare.
 * Modified in 2026 for TokenRouter Monitor.
...
static u8g2_st7305_t *s_active_display;
...
{
    (void)u8x8;
    u8g2_st7305_t *dev = s_active_display;
    if (dev == NULL) {
        return 0;
    }
...
esp_err_t u8g2_st7305_init(u8g2_st7305_t *dev, const u8g2_st7305_config_t *config)
{
    ...
    ESP_RETURN_ON_FALSE(s_active_display == NULL || s_active_display == dev,
                        ESP_ERR_INVALID_STATE, TAG, "only one display is supported");
