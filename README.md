...
```bash
VERSION=v0.1.29 ./scripts/build-app.sh
```
...
```bash
VERSION=v0.1.29 ARCHITECTURE=universal ./scripts/build-app.sh
```
...
for ARCHITECTURE in x86_64 arm64 universal; do
  VERSION=v0.1.29 ARCHITECTURE="$ARCHITECTURE" ./scripts/package-release.sh
done
```
...
```text
dist/Sub2APIStatusBar-0.1.29-macOS-x86_64.zip
dist/Sub2APIStatusBar-0.1.29-macOS-arm64.zip
dist/Sub2APIStatusBar-0.1.29-macOS-universal.zip
```
